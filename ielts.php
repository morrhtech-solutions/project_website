...
<div class="gmat_slider_div">
    <img src="images/courses/courses_breakdown/ielts.png" alt="">
</div>
...
<div class="gmat_body">
    <div class="classes"><br>
        ...
        <div class="physical">
            ...
            <p>1 Month Tuition: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 30,000 NGN</p>
            <p>Training Material:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 15,000 NGN</p>
            <small>*2,000 NGN charged for delivery outside Lagos and Abuja.</small><br><br><br>
            <p><span class="figure">45,000 NGN</span><button class="fees_button">pay</button></p>
        </div>
    ...
    <i class="fa-solid fa-calendar-days fa-3x"></i>
        <div class="total_fee">
        <h2>Register for IELTS exam here</h2><br><br>
        <button class="fees_button_total">Register</button>
        </div>
    </div>
</div>
</div>
...
<img src="images/courses/courses_breakdown/schedule(ielts).png" alt="">   
</div>
<!-- Ad section ends -->
